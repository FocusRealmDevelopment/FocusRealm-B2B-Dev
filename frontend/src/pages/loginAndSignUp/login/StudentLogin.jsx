                ...
                <div className="bg-white rounded-[20px] w-[90vw] max-w-[1200px] mx-auto relative top-[10vh] h-[80vh] flex overflow-hidden shadow-lg">
                    <div className="w-full md:w-1/2 p-8 flex flex-col justify-center items-center bg-white">
                        ...
                        <div className="text-center text-sm text-gray-600 mt-4">
                            Having an access code? <span className="text-blue-700 cursor-pointer">Login here</span>
                        </div>
                        <div className="text-center text-sm text-gray-600 mt-2">
                            New to Focus Realm? <button className="text-blue-700 cursor-pointer" onClick={() => navigate("/studentsignup")}>Create an account</button>
                        </div>
                    </div>
