...
import { clearErrors, loginStudent } from "../../../actions/studentAction"; // Change this to loginTeacher if you have a separate action
...
const TeacherLogin = () => {
    ...
    const loginSubmit = (e) => {
        e.preventDefault();
        // dispatch(loginStudent(loginEmail, loginPassword)) // Uncomment and change to loginTeacher if needed
    };
                        ...
                        <form method="post" onSubmit={loginSubmit} className="w-full max-w-sm flex flex-col">
                            ...
                            <div className="relative mb-4">
                                ...
                                <input
                                    ...
                                    className="pl-10 w-full rounded-[20px] bg-[#F5F5F5] h-12"
                                />
                            </div>
