...
export default function Lowicode()
{
    return(
        ...
        <img src={triangle} className='absolute bottom-0 left-[10px] w-[120px] h-[250px]'></img>
        <img src={circle} className='w-[250px] h-[240px] absolute right-0'></img>
        <img src={circle2} className=' w-[250px] h-[220px] absolute bottom-0 right-0'></img>
    <div className='w-screen h-screen flex justify-center items-center'>
        <div className=' C w-[85%] shadow-[#0148B7]  drop-shadow     rounded-[30px]  h-[75%]  absolute  border-[#0148B7] border-2'>
           ...
           <img src={img4} className='w-[15vw] self-stretch h-[15vw] absolute left-[150px] top-[110px]'></img>
          <div className='absolute top-[63%] left-[4%]'>
           <div className='font-semibold  text-white text-[2.7vw] '>
           Welcome to the Focus Realm
           </div>
           <div className='text-[1.3vw] L  text-white'>Step into Focus Realm,Where Distractions Fade and </div>
           <div className='flex justify-center'>
           <div className='absolute text-[1.3vw] text-white text-center '>Learning thrives!!</div>
           </div>
           </div>
...
<div className='flex justify-center'>
<img src={logo} className='absolute w-[250px] top-[5%] h-[120px]'></img>
</div>
...
<input type='text' placeholder='Access code' className=' dark:bg-[#303640] absolute top-[55%] left-[20%]'/>


<div className='flex justify-center'>
<div className='w-[63%] left-[20%] absolute top-[60%] h-0 border border-black'></div>
<div className='text-[#949494] font-medium text-[10px] absolute left-[20%] top-[61%]'>eg:222-333-444-555</div>
</div>



<button className='B absolute top-[69%] left-[19%] bg-[#0148B7]  w-[65%] h-[6%] text-white  rounded-[15px] '>Login</button>

<div className='flex justify-center'>
    <div className='absolute top-[75%] dark:text-white'>
     Dont have an account? <a className='text-[#0148B7]' href='#'>Sign Up</a>
    </div>
</div>
