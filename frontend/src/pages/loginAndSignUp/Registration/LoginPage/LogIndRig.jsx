        ...
        <Fragment>
          <div className="absolute left-[50%] w-[50%] h-[100%] ">
            ...
            <form onSubmit={LoginSubmit}>
              ...
              <div className="flex justify-center">
                <input
                  ...
                  className="w-[57%] h-[8%] absolute top-[29.5%] rounded-[15px] pl-[50px] Bg bg-[#0020511a]"
                />
              </div>
              ...
              <div className="top-[40%] absolute left-[23%] text-black text-[1.1vw] text-base font-semibold  tracking-wide dark:text-white">
                Password
                <IoMdLock
                  className="relative size-5 fill-[#0148B7] left-[0.5vw] 
              top-[1vw]  "
                />
              </div>
              <div className="flex justify-center">
              ...
              <div className="self-stretch justify-center items-center gap-[122px] inline-flex">
                <div className="grow shrink basis-0 h-10 px-[7px] py-1 bg-white bg-opacity-0 justify-start items-center gap-[3px] flex">
                  <input
                    type="checkbox"
                    className="grow shrink basis-0 absolute top-[57%] left-[22%] "
                  />
                  <span className="text-center text-black text-xs left-[25%] dark:text-white font-semibold absolute top-[57%] ">
                    Remember Me
                  </span>
                </div>
                <Link
                  to="/password/forgot"
                  className="absolute top-[57%] grow shrink basis-0 dark:text-white left-[65%] text-center text-black text-xs font-semibold "
                >
                  Reset Password
                </Link>
              </div>
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="B absolute top-[64%] bg-[#0148B7] w-[50%]  text-white h-[8%] rounded-[15px] "
                >
                  Login
                </button>
              </div>
              ...
              <div className="w-[20vw] absolute top-[75%] left-[26.5%]  h-[23px] px-1.5 bg-white bg-opacity-0 justify-center items-center gap-0.5 inline-flex">
                <div className="w-[129px] h-[0px] border border-neutral-400"></div>
                <div className="w-5 h-[23px] text-center text-neutral-400 text-[13px] font-medium font-['Poppins']">
                  or
                </div>
                <div className="w-[129px] h-[0px] border border-neutral-400"></div>
              </div>
            ...
            <div className=" w-full text-[1.2vw]   ">
              <div className=" dark:text-white absolute top-[90%] left-[26%]">
                Dont have an account? Create an account
              </div>
              <input
                type="checkbox"
                className="top-[91%] absolute left-[23%]"
              />
            </div>
          </div>
        </Fragment>
