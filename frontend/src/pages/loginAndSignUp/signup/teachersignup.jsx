...
const Signup = () => {
    ...
    const { isAuthenticated, error } = useSelector((state) => state.teacher);
    ...
    return (
        <div className="bg-white rounded-[20px] w-[80.5%] relative left-[10%] top-[10vh] h-[80vh] px-12">
            ...
            <div className="flex justify-center relative top-[8%]">
                <img src={Logo} className="w-[32px] h-[42px]" alt="Logo" />
            </div>
            ...
            <div className="flex justify-center relative bottom-[20%]">
                <div className="text">
                    ...
                    <button className="text-[#0148B7]" onClick={() => navigate("/Teacherlogin")}>
                        Login here
                    </button>
                </div>
            </div>
