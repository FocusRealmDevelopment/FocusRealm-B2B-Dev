...
const DetailedCalendar = () => {
    ...
    return (
        <div className={`py-5 px-8 ${themeMode === 'light' ? 'bg-[#EDF0F5]' : 'bg-[#262B33]'} `}>
            <div className="">
                <div className='flex'>
                ...
                <div className='flex border-[0.5px] rounded border-[#637799]'>
                    <div className='w-[300px] border-r-[0.5px] p-[15px] border-[#637799]' style={{ paddingRight: currentState === 2 ? '' : '65px' }}>
                        <div>
                    ...
                    <div className='' style={{ width: 'calc(100% - 300px)' }}>
                        <div className='flex items-center justify-between py-2 px-8 h-[100px] border-b-[0.5px] border-[#637799]'>
                            <div className='flex items-center'>
                                <button className='btn-1 bg-[#4F81D1] hover:bg-[#789dda]' style={{ background: themeMode === 'light' ? '#4F81D1' : '#0148B7' }}>Today</button>
