            ...
            <div className="calendar-2">
                <div className="calendar-header-2">
                    ...
                    <div className='navi-btn-container' style={{ margin: '5px' }}>
                        <button className='navi-btn btn-2 hov' style={{ borderStyle: 'none' }} onClick={this.goToPreviousMonth}>
                        ...
                        <button className='navi-btn btn-2 hov' style={{ borderStyle: 'none' }} onClick={this.goToNextMonth}>
                    ...
                    <div className="table-header-2">
                        {
                            this.weekdays.map((weekday, e) => {
                                return <div key={e} className="weekday-2"><p>{weekday}</p></div>
                            })
                        }
                    </div>
