...
const DaywiseCalendar = () => {
  ...
  return (
    <div className="flex ml-[-80px]">
      {/* Render day columns */}
      <div className="w-20">
        <div className="mb-[45px] h-12 flex items-center justify-center"></div>
      ...
      <div className="flex-1 grid">
        ...
        {daysOfWeek.map((day) => (
          <div
            ...
            className=" border-r border-gray-300 w-full relative"
          >
            <div className="border-b w-full border-gray-300">
              <p
                className="bg-[#D8DFEB] w-max py-[5px] px-[8px] text-[13px]"
                style={{ borderBottomRightRadius: "24px" }}
              >
                {day.format("DD")}
              </p>
              <snap className="uppercase text-center pb-[20px] flex justify-center items-center">
                {day.format("ddd")}
              </snap>
            ...
            {[...Array(24)].map((_, hour) => (
              <div
                key={hour}
                className="py-[24px] ml-[-15px] my-2 px-5 border-b border-gray-300"
              ></div>
            ))}
